...
export default function Hero() {
  return (
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[600px] flex flex-col items-center">
      <div
        className="md:h-[550px] h-[500px] w-[450px] bg-gradient-to-r absolute from-[#289397] via-[#289786]
      ...
      >
        ...
        >
          <img
            src={imghero}
            alt="Hero Image"
            className="h-[200px] sm:h-[400px] md:h-[590px] w-[250px] sm:w-[480px] object-cover rounded-lg"
          />
        </figure>
      </main>
    </div>
